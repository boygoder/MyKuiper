...
YoloDetectLayer::YoloDetectLayer(
    ...
    : Layer("yolo"), stages_(stages), num_classes_(num_classes),
      strides_(strides), anchor_grids_(anchor_grids), grids_(grids),
...
YoloDetectLayer::GetInstance(const std::shared_ptr<RuntimeOperator> &op,
