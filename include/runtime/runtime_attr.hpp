#ifndef KUIPER_INFER_INCLUDE_RUNTIME_ATTR_HPP_
#define KUIPER_INFER_INCLUDE_RUNTIME_ATTR_HPP_
...
template <class T> std::vector<T> RuntimeAttribute::get() {
  /// 检查节点属性中的权重类型
...
#endif // KUIPER_INFER_INCLUDE_RUNTIME_ATTR_HPP_
